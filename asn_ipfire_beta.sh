...
#######################################################################
  revision="asn_ipfire.sh v0.5.2"                    # do not comment out
# Last updated: June 19 2017 by maloe
...
# Main procedures
	...
	print_help() {																						# Help info
		...
		echo "usage example: asn_ipfire.sh -u -f company.lst "
		echo "               asn_ipfire.sh --network -f company.lst "
		echo
		echo "Notes:"
		echo "  Company names are handled case insensitive."
		echo "  Only entries made by asn_ipfire.sh are updated or removed."
